        ...
        <div className="entire-page">
          ...
          <table className="form-table">
            <tbody><tr style={{height: '21pt'}}>
              ...
              <tr style={{height: '23pt'}}>
                <td colSpan={4} className="blue-boxes" style={{borderRight: '3px solid #24418E'}}>
                  <div className="text-left">BODILY INJURY</div>
                </td>
              </tr>
              <tr style={{height: '23pt'}}>
                <td colSpan={4} className="white-boxes-red-text" style={{borderRight: '3px solid #24418E', borderLeft: '1px solid #24418E'}}>
                  <div className="text-left">If an employee was injured, please submit the form for an Employee Injury (Form 04) type of incident.</div>
                </td>
              </tr>
              <tr style={{height: '22pt'}}>
                <td className="blue-boxes">
        ...
        <div className="entire-page">
          ...
          <table className="form-table">
            <tbody><tr style={{height: '25pt'}}>
              ...
              <tr style={{height: '23pt'}}>
                <td colSpan={4} className="blue-boxes" style={{borderRight: '3px solid #24418E'}}>
                  <div className="text-left">PROPERTY DAMAGE</div>
                </td>
              </tr>
              <tr style={{height: '22pt'}}>
                <td className="blue-boxes">
              ...
              <tr style={{height: '23pt'}}>
                <td colSpan={4} className="blue-boxes" style={{borderRight: '3px solid #24418E'}}>
                  <div className="text-left">WITNESS INFORMATION</div>
                </td>
              </tr>
              <tr style={{height: '27pt'}}>
                <td className="blue-boxes">
